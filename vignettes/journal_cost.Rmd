...
vignette: "% \\VignetteIndexEntry{Cost of publishing in journals} \n% \\VignetteEngine{knitr::rmarkdown}\n%\\VignetteEncoding{UTF-8}\n"
---
...
Again, it's not elegant, and it would not scale up very well to the journal names (which have even more categories!).
